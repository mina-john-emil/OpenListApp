...
class _LoginPageState extends State<LoginPage> {
  OpenlistNativeUiLocalizations? localizations;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text(OpenlistNativeUiLocalizations.of(context).aListWebLogin),
        ),
        body: Center(
          child: Container(
      ...
      _list = <Widget>[
        ...
        Padding(
          ...
          child: TDInput(
            ...
            leftLabel: OpenlistNativeUiLocalizations.of(context).username,
        ...
        TDInput(
          ...
          backgroundColor: Colors.white,
          leftLabel: OpenlistNativeUiLocalizations.of(context).password,
          // hintText:
        ...
        Padding(
          ...
          child: Row(
            ...
            children: [
              TDButton(
                  icon: TDIcons.login,
                  text: OpenlistNativeUiLocalizations.of(context).login,
  ...
  Future<void> login_and_goto_dashboard(String username, password) async {
    ...
    try {
      ...
      if (response.statusCode == 200 && response.data["code"] == 200) {
        ...
        //  登录失败
        print(response.data);
        show_failed("Login failed:${response.data["message"]}", context);
      }
    } catch (e) {
      //  登录失败
